...
class FreeView extends GetView {
    ...
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          title: const Column(
            ...
            children: [
              Text('Free Presets',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 21),),
              Text('Welcome To App',style: TextStyle(color: Colors.white,fontSize: 14),),
            ],
          ),
          ...
          children: [
            Container(
                ...
                child:  SingleChildScrollView(
                    ...
                    child: Row(children: [
                      kButton(text: "Orange & Teal",),SizedBox(width: 5,),
                      kButton(text: "Moody",),SizedBox(width: 5,),
                      kButton(text: "Sky Colour",),SizedBox(width: 5,),
                      kButton(text: "Cinematic",),SizedBox(width: 5,),
                      kButton(text: "Potrait",),SizedBox(width: 5,),
                      kButton(text: "AUtumn",),SizedBox(width: 5,),
                      kButton(text: "Urban",),SizedBox(width: 5,),
                      kButton(text: "Wedding",),SizedBox(width: 5,),
                      kButton(text: "Winter",),SizedBox(width: 5,),
                      kButton(text: "Black & white",),
